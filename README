...
[![GitHub stars](https://img.shields.io/github/stars/genesisfield/mcalib-ripple?style=social)](https://github.com/genesisfield/mcalib-ripple/stargazers) [![Build Status](https://img.shields.io/badge/build-passing-brightgreen)](#) [![License](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)
...
- **Test Coverage** — Validates \(\mu(z=0.1)\approx38.3\) mag and \(d_L(0.1)\approx460\) Mpc
...
Built on the Pantheon+ and SH0ES datasets and the Python ecosystem (NumPy, SciPy, pandas, matplotlib, emcee).
